...
const LandingPage: React.FC = () => (
  <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
    ...
    <h1 className="text-4xl font-bold mb-2">Ornex Mail Dashboard</h1>
    <p className="text-lg text-gray-600 mb-6 max-w-xl">
      Welcome to Ornex Mail – your AI-powered Gmail dashboard!<br />
    ...
    <div className="flex gap-4">
      ...
      <a href="/inbox" className="bg-gray-200 text-gray-800 px-4 py-2 rounded hover:bg-gray-300 transition">Inbox</a>
    </div>
  </div>
);
